...
![data type ](https://via.placeholder.com/468x300?text=Data+type+screenshot)
...
![horsepower ](https://via.placeholder.com/468x300?text=Horse+Power+_+Q) 
...
![Outliers Example ](https://via.placeholder.com/468x300?text=Outliers+Example)
...
![Box plot ](https://via.placeholder.com/468x300?text=Box+plot)   
...
![Outliers count ](https://via.placeholder.com/468x300?text=Outliers+count)
...
![Pair plot ](https://via.placeholder.com/468x300?text=Pair+plot) 
...
![Correlation statics ](https://via.placeholder.com/468x300?text=Correlation+statics) 
...
![Histogram distribution](https://via.placeholder.com/468x300?text=Histogram+distribution)
...
![Q-Q plot](https://via.placeholder.com/468x300?text=Q-Q+plot) 
...
![Dummy variables](https://via.placeholder.com/468x300?text=Dummy+Variables) 
...
![Score](https://via.placeholder.com/468x300?text=Score)   
We can also visualize how the model fitted on train and test data using matplotlib
#### Model on training
![Model on training](https://via.placeholder.com/468x300?text=Model+on+training)
#### Model on testing   
![Model on testing](https://via.placeholder.com/468x300?text=Model+on+testing)
#### Evaluation Metrics
...
##### RMSE: sqrt((Σ(y-ŷ)^2)/n) 
![MAE,MSE,RMSE](https://via.placeholder.com/468x300?text=MAE+MSE+RMSE)
### Conclusion
...
![Model coefficients](https://via.placeholder.com/468x300?text=Model+coefficients) 
